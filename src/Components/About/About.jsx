        ...
        >
            ...
            >
                ...
                <Box
                    ...
                    w={{ sm: "70%", md: "50%" }}
                >
                    <Image src="/ProfilePic.jpg" alt='Image not found' fallbackSrc='https://via.placeholder.com/150' boxSize={"70%"} borderRadius={"50%"} border={'2px solid #339ec0'} objectFit={"cover"} draggable={"false"} />
                </Box>
            </Box>
        </Box>
    )
